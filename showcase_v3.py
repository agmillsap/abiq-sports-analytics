...
def _payload() -> dict[str, object]:
    return {
        ...
        "kpis": [
            ...
            {"icon": "bars", "title": "PROBABILITY QUALITY", "value": "0.2144", "subtext": "Brier score · 0 best / 1 worst"},
        ],
        "games": [
        ...
        "performance_metrics": [
            ...
            {"label": "PROBABILITY QUALITY", "value": "0.2144", "detail": "Brier score: 0 = perfect, 1 = worst; squared probability error penalizes confidently wrong forecasts more heavily"},
